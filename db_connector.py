...
import hashlib
import pandas as pd
from conn.hdl.utils import open_var_ids, listify_var_ids, get_var_df

class DBConnector:
    
    def __init__(self, user:str="", psw:str="", target_db: str="hdl", extract_date = None):
    ...
    def hash_id_columns(self, df = None):
        ...
        for col in hash_cols:
            df[col] = [hashlib.sha256((""+str(v))\
                .encode("utf-8")).hexdigest() for v in df[col]]
        return df
